...
@section('content')
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Anasayfa</a> <a
                href="#" class="current">Foto Galeri Yönetimi</a></div>
        <h1>Foto Galeri Yönetimi</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i class="icon-th"></i></span>
                        <h5>Fotoğraf Galerileri</h5>
                        <div style="float: right; margin: 3px 10px 3px 3px; overflow: hidden">
                            <a href="{{route('photo_gallery.create')}}" class="btn btn-success"><i
                                ...
                                <tr class="gradeA">
                                    <td style="text-align: center">
                                        @if(!empty($item->image) && file_exists(public_path("/uploads/photo_gallery/".$item->folder_name."/".$item->image)))
                                            <a href="/uploads/photo_gallery/{{$item->folder_name."/".$item->image}}"
                                               target="_blank"
                                               class="tip"

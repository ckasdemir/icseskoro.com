...
@section('content')
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Anasayfa</a> <a
                href="#" class="current">Video Galeri Düzenle</a></div>
        <h1>Video Galeri Düzenle</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"> <i class="icon-align-justify"></i> </span>
                        <h5>Video Galeri Düzenle : {{$video_gallery->title}}</h5>
                    </div>
                    <div class="widget-content nopadding">
                        {!! Form::model($video_gallery, ['route'=>['video_gallery.update', $video_gallery->id], 'method'=>'PUT', 'class'=>'form-horizontal', 'files' => 'true']) !!}
                        <div class="control-group">
                            <label class="control-label">Başlık :</label>
                            <div class="controls">
                                <input type="text" name="title" class="span11" value="{{$video_gallery->title}}"/>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="span11" name="description"
                                          rows="6">{{$video_gallery->description}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                @if(!empty($video_gallery->image))
                                    <a href="/uploads/video_gallery/{{$video_gallery->image}}"
                                       title="{{$video_gallery->slug}}"
                                       alt="{{$video_gallery->slug}}" target="_blank">Resmi göster</a>
                                @endif
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-danger"
                                    onclick="window.location.href='{{route('video_gallery.index')}}'">İptal
                            </button>
                        </div>
                        {!! Form::close() !!}
                    </div>

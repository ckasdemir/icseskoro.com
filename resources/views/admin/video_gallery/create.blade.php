...
@section('content')
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Anasayfa</a> <a
                href="#" class="current">Video Galeri Ekle</a></div>
        <h1>Video Galeri Ekle</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"> <i class="icon-align-justify"></i> </span>
                        <h5>Video Galeri Ekle</h5>
                    </div>
                    <div class="widget-content nopadding">
                        {!! Form::open(['route'=>'video_gallery.store','method'=>'POST','class'=>'form-horizontal', 'files' => 'true']) !!}
                        <div class="control-group">
                            <label class="control-label">Başlık :</label>
                            <div class="controls">
                                <input type="text" name="title" class="span11" placeholder="Video galeri başlığı"/>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="span11" name="description" rows="6"
                                          placeholder="Video galeri açıklaması ..."></textarea>
                            </div>
                        </div>
                        <div class="control-group">

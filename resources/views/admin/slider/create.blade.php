...
@section('content')
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Anasayfa</a> <a
                href="#" class="current">Foto Slide Ekle</a></div>
        <h1>Foto Slide Ekle</h1>
    </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title" class="span11" placeholder="Foto slide başlığı"/>
                            </div>
                        </div>
                        <div class="control-group">
